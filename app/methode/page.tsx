      ...
      <section className="section" style={{ background: 'var(--gray-50)' }}>
        <div className="container">
          <div className="section-header" style={{ textAlign: 'center' }}>
            ...
            <p style={{ maxWidth: '700px', margin: '1rem auto', color: 'var(--gray-700)', fontSize: '1.05rem' }}>La méthode repose sur quatre familles de techniques complémentaires qui agissent en synergie sur le corps et l&apos;esprit.</p>
          </div>

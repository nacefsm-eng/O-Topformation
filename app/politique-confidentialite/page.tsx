        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
            ...
            <div>
              ...
              <p>SAS Ô&apos;TOP Formation — Présidente : Mélissa Jennadi — Email : contact@otopformation.fr — Téléphone : 07 67 24 68 25</p>
            </div>
            ...
            <div>
              ...
              <p style={{ marginTop: '1rem' }}>Pour exercer ces droits : <a href="mailto:contact@otopformation.fr" style={{ color: 'var(--blue-700)' }}>contact@otopformation.fr</a></p>

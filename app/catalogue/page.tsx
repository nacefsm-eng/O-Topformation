...
const formations = [
  {
    id: 'fi-top',
    icon: <Brain size={28} />,
    badge: 'Méthode TOP® — Dr Édith Perreaut-Pierre',
    badgeColor: 'amber',
    title: "Formation initiale aux Techniques d'Optimisation du Potentiel (FI-TOP®)",
    ...
    description: "Une méthode issue du Service de santé des armées et du sport de haut niveau : respiration, relaxation et imagerie mentale pour mieux gérer le stress, préserver son énergie et accompagner le changement.",
    highlights: [
      '21 h en présentiel ou distanciel',
      '2 h accompagnement avec un expert incluses',
      'Éligible prise en charge OPCO / FAF',
  ...
  },
  {
    ...
    badge: 'Prépare à la certification RS6776 (France Compétences)',
    badgeColor: 'cyan',
    ...
    description: "Maîtrisez ChatGPT, Claude et le prompting métier pour créer vos contenus. Confidentialité des données, conformité AI Act & RGPD. 21 h, dont 2 h d'accompagnement avec un expert.",
    highlights: [
      'Durée : 21 h, dont 2 h d\'accompagnement avec un expert',
      'Format : 100 % en ligne, à votre rythme',
      'Confidentialité des données, conformité AI Act & RGPD',
      '600 € au lieu de 1 490 €, jusqu\'au 31 octobre 2026',
    ],
  ...
  },
  {
    id: 'ia-rs7344',
    icon: <Bot size={28} />,
    badge: 'Prépare à la certification RS7344 (France Compétences)',
    badgeColor: 'indigo',
    ...
    description: "Audit des flux avec la méthode STEP, intégration de l'IA dans vos processus et conformité AI Act. 21 h, dont 2 h d'accompagnement avec un expert.",
    highlights: [
      'Durée : 21 h, dont 2 h d\'accompagnement avec un expert',
      'Feuille de route stratégique & audit STEP',
      'Conduite du changement & conformité AI Act',
      'Financement OPCO & FAF possible',
    ],
  ...
  },
  {
    id: 'rs7351',
    icon: <Share2 size={28} />,
    badge: 'Prépare à la certification RS7351 (France Compétences)',
    badgeColor: 'pink',
    ...
    description: "Créer vos visuels avec Canva, monter des vidéos CapCut et prospecter sur LinkedIn, avec vos premières campagnes Meta Ads. 21 h, dont 2 h d'accompagnement avec un expert.",
    highlights: [
      'Durée : 21 h, dont 2 h d\'accompagnement avec un expert',
      'Ligne éditoriale et planning de diffusion',
      'Prospection LinkedIn ciblée et premières publicités Meta Ads',
      'Tableau de reporting pour piloter votre stratégie',
    ],
  ...
  },
  {
    id: 'fb-top',
    icon: <Clock size={28} />,
    badge: 'Module découverte • 1 journée',
    badgeColor: 'amber',
    title: 'Formation flash TOP® (FB-TOP) — 7 h',
    subtitle: 'Module Découverte Express',
    duration: '7 h',
    price: 390,
    priceDisplay: '390 €',
    href: '/formations/fi-top',
    stripeOffer: 'Formation Flash TOP (FB-TOP 7h)',
    description: "Techniques de respiration pour gérer le stress aigu et la fatigue. Idéal pour une initiation rapide en équipe ou en individuel.",
    highlights: [
      'Durée : 7 h (1 journée)',
      'Protocoles de respiration et régulation flash',
